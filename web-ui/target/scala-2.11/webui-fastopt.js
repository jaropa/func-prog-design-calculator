...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  var values = new $c_sr_ObjectRef().init___O(elem);
  ...
  new $c_sc_TraversableLike$WithFilter().init___sc_TraversableLike__F1(namedExpressions, p).foreach__F1__V(new $c_Lcalculator_Calculator$$anonfun$computeValues$2().init___sci_Map__sr_ObjectRef(namedExpressions, values));
  return $as_sci_Map(values.elem$1)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.init___sci_Map__sr_ObjectRef = (function(namedExpressions$1, values$1) {
  this.namedExpressions$1$f = namedExpressions$1;
  this.values$1$2 = values$1;
  return this
});
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T2__V = (function(x$1) {
  if ((x$1 !== null)) {
    var str = $as_T(x$1.$$und1$f);
    var sign = $as_Lcalculator_Signal(x$1.$$und2$f);
    var jsx$2 = this.values$1$2;
    var jsx$1 = $as_sci_Map(this.values$1$2.elem$1);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, sign$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(sign$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, sign));
